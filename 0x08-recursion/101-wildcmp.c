...
int wildcmp(char *s1, char *s2)
{
	...
	/**
	 * if the chars are equalin both strings,
 ...
 * Return: the sddress of the character after the *
 */
char *move(char *s2)
{
	/**
	 * if thr current char is a *
	 * increment s2 by 1
