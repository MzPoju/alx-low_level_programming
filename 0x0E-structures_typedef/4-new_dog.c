...
/**
 * new_dog - creates a funtion that creates a new dog
 * @name: the copy of name to be stored
 * @age: the copy of age to be stored
 * @owner: the copy of owner to be stored
 *
 * Return: Always zero
 */
