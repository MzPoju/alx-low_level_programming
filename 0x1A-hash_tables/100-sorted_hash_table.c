 ...
 * Return: If an error occurs - NULL, else a pointer to the new sorted hash table
 */
shash_table_t *shash_table_create(unsigned long int size)
{
	shash_table_t *ht;
 ...
 * Return: If the key cannot be matched - NULL, else the value associated with key in ht
 */
char *shash_table_get(const shash_table_t *ht, const char *key)
{
	shash_node_t *node;
